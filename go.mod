module github.com/wjmelements/localnet
...
require (
	...
	github.com/filecoin-project/lotus v0.0.0
)
...
replace (
	github.com/filecoin-project/filecoin-ffi => ./lotus-local-net/extern/filecoin-ffi
	github.com/filecoin-project/lotus => ./lotus-local-net
)
